...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
    (
        ...
        const variants = {
            primary:
                'bg-gradient-to-r from-primary to-secondary text-white hover:shadow-lg hover:-translate-y-0.5 focus:ring-primary',
            secondary:
                'bg-secondary text-white hover:bg-secondary-dark focus:ring-secondary',
            accent:
                'bg-gradient-to-r from-accent to-accent-light text-white hover:shadow-lg hover:-translate-y-0.5 focus:ring-accent',
            outline:
                'border-2 border-primary text-primary hover:bg-primary hover:text-white focus:ring-primary bg-transparent',
            ghost:
                'text-text hover:bg-surface-hover focus:ring-primary bg-transparent',
            whatsapp:
